...
class DataRepository {
  ...
  Future<List<Employee>> getAllEmployee() async {
    ...
    try {
      ...
      final List<dynamic> result = data0['data'] as List<dynamic>;
      if (prefs.containsKey(prefsEmployeeKey)) {
        prefs.remove(prefsEmployeeKey);
        prefs.reload();
      }
      prefs.setString(prefsEmployeeKey, jsonEncode(data0['data']));
      employee = result
          .map(
      ...
      final List<dynamic> data0 = data['data'] as List<dynamic>;
      employee = data0
          .map(
              (dynamic json) => Employee.fromJson(json as Map<String, dynamic>),)
          .toList();
  ...
  Future<User> getMyData() async {
    ...
    try {
      ...
      prefs.reload();
      prefs.setString(prefsUserKey, jsonEncode(data['data']));
