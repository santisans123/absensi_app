            ...
            ExpansionPanel(
                ...
                body: Column(
                  children: employees[index].presences.map((presence) {
                    ...
                    final isFirst = index0 == 0;

                    final isLast = index0 == 3;
                    ...
                    if (!isFirst) {
                      final presence = employees[index].presences[index0 - 1];
                      beforeLineColor = presence.startTime.isFinished()
                          ? checkStatusColor(presence.status)
                          : Colors.grey[300];
                    }
                  ...
                  delegate: SearchPage(
                    ...
                    barTheme: ThemeData(
                      appBarTheme: const AppBarTheme(
                        color: Colors.blueAccent, systemOverlayStyle: SystemUiOverlayStyle.light,
                      ),
                    ),
