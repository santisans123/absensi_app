...
class ListUndonePersonal extends StatefulWidget {
  ListUndonePersonal({
    Key key,
  }) : super(key: key);

  @override
  _ListUndonePersonalState createState() => _ListUndonePersonalState();
}

class _ListUndonePersonalState extends State<ListUndonePersonal> {
  ...
  void _loadData() {
    apiProvider.getTodoUndonePersonal().then((response) {
