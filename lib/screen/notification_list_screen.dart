...
class _NotificationListScreenState extends State<NotificationListScreen> {
  ...
  Future<void> getUser() async {
    ...
    final data = sp.get(prefsUserKey);
  ...
  Future<void> _fetchNotificationsData() async {
    try {
      ...
      final Map<String, dynamic> result = await dataRepo.getAllNotifications();
      final List<dynamic> notifications = result['data'] as List<dynamic>;
      final List<UserNotification> data = notifications
          .map(
  ...
  Future<void> _readAllNotifications() async {
    ...
    try {
      pd.show();
      final Map<String, dynamic> res = await dataRepo.readAllNotifications();
  ...
  Future<void> _deleteAllNotifications() async {
    ...
    try {
      pd.show();
      final Map<String, dynamic> res = await dataRepo.deleteAllNotifications();
      if (res['success'] as bool) {
        pd.hide();
        showAlertDialog("success", "Sukses", res['message'].toString(),
            dismissible: true,);
